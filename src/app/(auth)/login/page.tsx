    ...
    >
      ...
      >
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            disabled
            className="w-full py-3 border-2 border-gray-800 text-gray-600 font-title text-base uppercase tracking-widest cursor-not-allowed opacity-60 flex items-center justify-center gap-2"
          >
